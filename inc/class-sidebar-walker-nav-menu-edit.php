			...
			<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				<p class="description description-thin">
					<label for="edit-menu-item-title-display-<?php echo $item_id; ?>">
						...
						<?php
							$options = array( 'none' => __('None', CSHP_WM_TEXTDOMAIN), 'inside' => __('Inside container', CSHP_WM_TEXTDOMAIN), 'outside' => __('Outside container', CSHP_WM_TEXTDOMAIN) );
				...
				<?php if( 'sidebar' == $item->type ) : ?>
					...
					<p class="field-link-container-target-proxy description description-thin">
						<label for="edit-menu-item-target-<?php echo $item_id; ?>">
							<?php _e( 'Container Element', CSHP_WM_TEXTDOMAIN ); ?><br />
				...
				<div class="menu-item-actions description-wide submitbox">
					<?php if ( 'sidebar' == $item->type ) : ?>
						<p class="link-to-original">
							<?php printf( __('Sidebar Shown: %s', CSHP_WM_TEXTDOMAIN), '<a href="' . admin_url( 'widgets.php' ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
						</p>
